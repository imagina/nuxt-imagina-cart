<template>
  ...
  export default {
    ...
    computed: {
      ...
      settings() {
        return {
          captchV2: this.authStore.getSetting('isite::reCaptchaV2Site') ,
          captchV3: this.authStore.getSetting('isite::reCaptchaV3Site'),
          activeCaptcha: this.authStore.getSetting('isite::activateCaptcha')
        }
      },
